...
I.VoiceTTS = { create:() => {
    if(S['use-voice-tts']) {
        ...
        const VoiceTTS = I.VoiceTTS = {
            ...
            speak: () => {
                ...
                console.log('VoiceTTS speak ' + (I.PageObserver.Current.List[0] ? B.Title + '=' +
                                                 ...
                                                 I.PageObserver.getP({ Page: rightPage.Item.Pages[rightPage.IndexInItem + 1] }) + '=' +
            ...
            initialise: () => {
                VoiceTTS.voiceSubPanel = I.createSubpanel({
                    Opener: I.Menu.R.addButtonGroup({ Sticky: true, id: 'bibi-buttongroup_voice' }).addButton({
                        Type: 'toggle',
                        Labels: {
                            default: { default: `Text to speech`,     ja: `Text to speech` },
                            active:  { default: `Close Text to speech Menu`, ja: `Close Text to speech Menu` }
                        },
        ...
        VoiceTTS.initialise();
        //E.add('bibi:opened',           () => console.log('voice opened'));
        //E.add('bibi:transformed-book', () => console.log('voice transformed-book'));
    };
    E.dispatch('bibi:created-voice');
}};
